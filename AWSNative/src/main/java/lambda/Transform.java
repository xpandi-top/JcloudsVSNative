...
public class Transform implements RequestHandler<Request, HashMap<String, Object>> {
    ...
    public HashMap<String, Object> handleRequest(Request request, Context context) {
        ...
        if (s3Client==null){
            ...
            if (!isMac) logger.log("Start initializing");
        }
        ...
        try {
            ...
            String filename = "Transform_Native_"+objectName;
            s3Client.putObject(containerName, filename, is, meta);
            if (!isMac) logger.log("Transformed");
        } catch (Exception e) {
            e.printStackTrace();
            if (!isMac) logger.log(e.toString());
            connect = false;
    ...
    public static void main(String[] args) {
        ...
        transform.handleRequest(new Request(), new Context() {
            @Override
